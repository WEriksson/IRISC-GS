...
int init_global_utils(void* args){
     ...
     */
    //tc_logg_file = fopen("/home/zodox/Desktop/IRISC-GS/output/tc_logg.txt", "a");
    //tm_logg_file = fopen("/home/zodox/Desktop/IRISC-GS/output/tm_logg.txt", "a");
    tc_logg_file = fopen("./output/tc_logg.txt", "a");
    tm_logg_file = fopen("./output/tm_logg.txt", "a");
